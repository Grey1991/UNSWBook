...
<form id="newsearch" method="post" action="visualisations_servlet" style=" 
    /* margin-bottom: 50px; */
">
    <div class="" style="width: 40%;margin-left: auto;margin-right: auto;">
        <div class="search" style="margin-top: 50px;margin-bottom: 20px;">
            <!-- hidden input tag to identify this form action as search -->
            <input type="hidden" name="action" value="searchForPeople">
            <b>search for people</b><br>
            <b>UserName:</b><br>
...
">
    <div class="" style="width: 40%;margin-left: auto;margin-right: auto;">
        <div class="search" style="margin-top: 10px;margin-bottom: 20px;">
            <!-- hidden input tag to identify this form action as search -->
            <input type="hidden" name="action" value="searchForMessage">
            <b>search for message</b><br>
            <div>
            <input type="text" name="message" class="searchTerm" value="" size="100" maxlength="100" style="width: 90%; border-bottom-right-radius: 0; border-top-right-radius: 0;">
            <%--<br><br>--%>
            <button type="submit" value="search" class="searchButton" style="width: 10%;border-bottom-left-radius: 0;border-top-left-radius: 0;"><span class="glyphicon glyphicon-search"></span></button>
            </div>
        </div>
    </div>
</form>
...
">
    <div class="" style="width: 40%;margin-left: auto;margin-right: auto;">
        <div class="search" style="margin-top: 10px;margin-bottom: 100px;">
            <!-- hidden input tag to identify this form action as search -->
            <input type="hidden" name="action" value="searchForFriendsOfFriends">
            <b>search for friends of friends</b><br>
            <button type="submit" value="search" class="searchButton" style="margin-left: 77%"><span class="glyphicon glyphicon-search"></span> Search</button>
        </div>
    </div>
</form>
